...
lower_bound <- apply(df, 1, function(y) quantile(y, probs = (1 - 0.95) / 2))
upper_bound <- apply(df, 1, function(y) quantile(y, probs = (1 + 0.95) / 2))

ggplot() +
  geom_point(aes(sample = df), stat = "qq", color = "blue") +
  geom_abline(slope = 1, intercept = 0, color = "red") +
  geom_ribbon(aes(x = rnorm(200,0,1), ymin = lower_bound, ymax = upper_bound), alpha = 0.2, fill = "red") +
  ggtitle("Gráfico Q-Q com Bandas de Confiança") +
  xlab("Quantis Teóricos") +
  ylab("Quantis dos Dados")
